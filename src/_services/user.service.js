...
function getAll() {
  ...
  return fetch(config.apiUrl + "/api/customer", requestOptions).then(
    handleResponse,
    handleError
  );
}
...
function getById(id) {
  ...
  return fetch(config.apiUrl + "/users/" + _id, requestOptions).then(
    handleResponse,
    handleError
  );
}
...
function getAccount() {
  ...
  return fetch(config.apiUrl + "/api/customer/accounts", requestOptions).then(
    handleResponse,
    handleError
  );
}
...
function getBeneficiaryAccount(accountInfo) {
  ...
  return fetch(config.apiUrl + "/api/account/", requestOptions).then(
    handleResponse,
    handleError
  );
}
...
function addBeneficiary(beneficiaryInfor) {
  ...
  return fetch(
    config.apiUrl + "/api/customer/add-beneficiary",
    requestOptions
  ).then(handleResponse, handleError);
}
...
function updateListBeneficiaryInfo(listInfo) {
  ...
  return fetch(
    config.apiUrl + "/api/customer/update-beneficiary/",
    requestOptions
  ).then(handleResponse, handleError);
}
...
function getBeneficiaryAccounts() {
  ...
  return fetch(
    config.apiUrl + "/api/customer/beneficiaries",
    requestOptions
  ).then(handleResponse, handleError);
}
...
function transferIntrabank(transferInfor) {
  ...
  return fetch(
    config.apiUrl + "/api/customer/intrabank-transfer-money/",
    requestOptions
  ).then(handleResponse, handleError);
}
...
function register(user) {
  ...
  return fetch(config.apiUrl + "/api/customer/add", requestOptions).then(
    handleResponse,
    handleError
  );
}
...
function getDebtsList() {
  ...
  return fetch(config.apiUrl + "/api/customer/debts", requestOptions).then(
    handleResponse,
    handleError
  );
}
